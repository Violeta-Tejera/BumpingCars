...
*Observaciones:
  ...
  - Mencionar también que el explorador de archivos del IDE es bastante limitado. Es un poco complicado mover archivos entre directorios sin desesperarse. Dos maneras:
       ...
       - Pasándolo al **ESP**/_PC_, entrando en el directorio en cuestión y mandar el archivo de vuelta desde el **ESP**/_PC_ (al _PC_/**ESP**). Importante que no se trata de transferencias sino de copias, por lo que habrá que eliminar a mano las copias intermedias.
